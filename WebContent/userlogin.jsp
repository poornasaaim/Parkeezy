...
<div class="login-page">
  <div class="form">
    <form class="register-form" action="Donorlog" method="post">
    ...
    <form class="login-form" action="Donorlog" method="post">
      ...
      <p class="message">Not registered? <a href="userregister.jsp" style="color:#fc7e0f";>Create an account</a></p>
    </form>
  </div>
</div>
</body>
