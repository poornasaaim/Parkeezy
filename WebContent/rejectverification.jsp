...

{
	...
	try{
		...
		st.executeUpdate("UPDATE parkingslot.payment p SET relievingtime='"+time+"',parkedornot='relieved' where id='"+id+"' ");
		
		if(num.equals("1")){
		st.executeUpdate("UPDATE parkingslot.application a SET slot1status='Available' where id='"+park+"' ");
		}
		if(num.equals("2")){
			st.executeUpdate("UPDATE parkingslot.application a SET slot2status='Available' where id='"+park+"' ");
			}
		if(num.equals("3")){
			st.executeUpdate("UPDATE parkingslot.application a SET slot3status='Available' where id='"+park+"' ");
			}
		if(num.equals("4")){
			st.executeUpdate("UPDATE parkingslot.application a SET slot4status='Available' where id='"+park+"' ");
			}
		if(num.equals("5")){
			st.executeUpdate("UPDATE parkingslot.application a SET slot5status='Available' where id='"+park+"' ");
			}
