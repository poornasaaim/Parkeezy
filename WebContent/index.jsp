...
<div class="container">
	<div class="titular">		
		...
		<button class="btntop" style="margin-right:180px;"><a href="chiefofficerlogin.jsp">Admin</a></button>
		<button class="btntop"style="margin-right:40px;" ><a href="pollingofficerlogin.jsp">Lender</a></button>
		
		<button class="btntop" style="margin-right:-60px;"><a href="userlogin.jsp">User</a></button>
