...
<div class="contactform">
  <div style="text-align:center">
    <h1>Relieve</h1>
    <p>Thank you For Visiting Us... welcome Again</p>
  </div>
 ...
 String number="";
 con=dbconn.create();
 PreparedStatement ps=con.prepareStatement("SELECT * FROM `parkingslot`.`payment` where usermail='"+mail+"' and relievingtime='' ");
 ...
 %>
  <div class="row">
    <div class="column">
      <form action="rejectverification.jsp">
       ...
       <input type="hidden" value="<%=rs.getString(2) %>"  id="email" name="parking" placeholder="Your Email..">
        <input type="hidden" value="<%=rs.getString(16) %>"  id="email" name="number" placeholder="Your Email..">
