...
<%session.setAttribute("tovote","hi"); %>
 <div class="header">
        <div class="nav-menu">
            ...
            <div class="menu">
                <ul>
                    <li><a href="application.jsp" class="active">Application</a></li>
                    <li><a href="toactivatekit.jsp">Slot Approved</a></li>
                    <li><a href="voting.jsp">To Voters</a></li>
                    <li><a href="todeactivatekit.jsp">To Deactivate Kit</a></li>
                    <li><a href="#">Contact us</a></li>
                </ul>
            </div>
        </div>
        <div class="banner"> 
            <h1>Voting Mainpage</h1>
            <p>Vote Now to build democracy</p>
